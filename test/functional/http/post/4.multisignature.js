	...
	describe('schema validations', () => {
		...
		describe('keysgroup', () => {
			...
			it('using same member twice should fail', () => {
				...
				transaction.asset.multisignature.keysgroup.push(`+${accountFixtures.existingDelegate.publicKey}`);
				transaction = elements.redoSignature(transaction, scenarios.regular.account.password);
			...
			it('using invalid publicKey should fail', () => {
				...
				transaction.asset.multisignature.keysgroup.push(`L${accountFixtures.existingDelegate.publicKey.slice(0, -1)}`);
				transaction = elements.redoSignature(transaction, scenarios.regular.account.password);
